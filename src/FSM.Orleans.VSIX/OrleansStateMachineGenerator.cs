...
namespace FSM.Orleans.VSIX
{
    [ComVisible(true)]
    [Guid("F15F1915-CDBD-46B1-9B35-72E3C04D9D0E")]
    [CodeGeneratorRegistration(typeof(OrleansStateMachineGenerator), "OrleansStateMachineGenerator", vsContextGuids.vsContextGuidVCSProject, GeneratesDesignTimeSource = true)]
    [ProvideObject(typeof(OrleansStateMachineGenerator))] 
    class OrleansStateMachineGenerator : IVsSingleFileGenerator, IObjectWithSite
    {
